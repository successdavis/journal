    ...
    <aside class="h-full">
        <div class="overflow-y-auto py-4 px-3 bg-gray-800 h-full rounded">
            <ul class="space-y-2 text-gray-200">
                ...
                <li>
                    <Link href="/author/my-submissions" class="flex items-center p-2 pl-11 w-full text-base font-normal rounded-lg transition duration-75 group hover:bg-gray-100">My Downloads</Link>
                </li>

                <li>
                    <Link href="/home" class="flex absolute bottom-5 items-center p-2 text-base font-normal rounded-lg hover:bg-gray-100">
