    ...
    <aside class="h-full">
        <div class="overflow-y-auto py-4 px-3 bg-gray-800 h-full rounded">
            <ul class="space-y-2 text-gray-200">
                ...
                <li>
                    <Link href="/reviewer/assigned-reviews" class="flex items-center p-2 pl-11 w-full text-base font-normal rounded-lg transition duration-75 group hover:bg-gray-100">Assigned Reviews</Link>
                </li>
                <li>
                    <Link href="/reviewer/review-history" class="flex items-center p-2 pl-11 w-full text-base font-normal rounded-lg transition duration-75 group hover:bg-gray-100">Review History</Link>
                </li>
